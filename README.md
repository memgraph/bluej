...
Replace did:plc:ewgejell4547pukut5255ibm with the DID from your account (src/getDid.ts can help with that) and /home-plus with the name of your feed. If it works you should see an output like
